...
//Class Define
@Config
@Autonomous(name = "RFM2", group = "Autonomous")
public class RedFarStateM2 extends LinearOpMode {
...
// Trajectories
        ...
        TrajectoryActionBuilder intakingBottom = drive.actionBuilder(new Pose2d(36,20,Math.toRadians(90)))
                .strafeTo(new Vector2d(36,32))
                .strafeTo(new Vector2d(36,55), new TranslationalVelConstraint(4));
        TrajectoryActionBuilder shootSet2 = drive.actionBuilder(new Pose2d(36,55,Math.toRadians(90)))
                .strafeToLinearHeading(new Vector2d(60,16), Math.toRadians(150));
        TrajectoryActionBuilder outsideSet = drive.actionBuilder(new Pose2d(60,16,Math.toRadians(150)))
