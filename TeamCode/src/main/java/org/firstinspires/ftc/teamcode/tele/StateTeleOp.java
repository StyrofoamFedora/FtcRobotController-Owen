...
public class StateTeleOp extends LinearOpMode {
    ...
    boolean frontSlot, blSlot, ballStorage;
    ...
    public void runOpMode(){
        ...
        while (opModeIsActive()){
            ...
            telemetry.addData("ballStorage", ballStorage);
    ...
    private void updateIntake(){
        ...
        else if (gamepad1.right_trigger>0.2) {intakeControl=0.8;intakeLockControl=0.9;}
    ...
    private void updateSpindex(){
        if(frontSlot && !ballStorage && (autoIntakeTimer.seconds()>0.5)){
            if(blSlot){
                intakeControl = 0;
