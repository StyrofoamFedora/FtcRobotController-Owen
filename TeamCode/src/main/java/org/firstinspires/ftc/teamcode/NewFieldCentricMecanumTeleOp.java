...
public class NewFieldCentricMecanumTeleOp extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (currentGamepad2.dpad_left && !previousGamepad2.dpad_left){spindexer.setTargetPosition(spindexer.getCurrentPosition()-slotTicks);ballSlot -= 1;} //Previous Ball Slot
            if (currentGamepad2.dpad_right && !previousGamepad2.dpad_right){spindexer.setTargetPosition(spindexer.getCurrentPosition()+slotTicks);ballSlot += 1;} //Next Ball Slot
